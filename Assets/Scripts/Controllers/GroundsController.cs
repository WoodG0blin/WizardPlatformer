...
namespace WizardsPlatformer
{
    public class GroundsController : Controller
    {
        ...
        private readonly string _assetPath = "Grounds"; //TODO: replace with SO config
        ...
        public GroundsController(int maxLength, LevelModel levelModel)
        {
            ...
            foreach(Tile tile in _groundsView.groundTiles) _tiles.Add(tile.name, tile);

            _tilemapBase = _groundsView.groundTilemap;
        ...
        {
            _tilemapBase.ClearAllTiles();
            foreach(LevelElement element in _elements) element.Dispose();
            _elements.Clear();
        }
    }
}
